...
export default function ChallengesPage() {
  ...
  const loadChallenge = async () => {
    try {
      ...
      console.error('[v0] Load challenge error:', error)
    } finally {
      setLoading(false)
    }
  }
        ...
        {loading ? (
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-[#1a1a3a] border border-[#333333] rounded-lg p-8">
              ...
              <p className="text-[#ffffff] text-lg mb-6">{challenge.description}</p>
              ...
              <div className="bg-[#0f0f23] border border-[#333333] rounded p-6 mb-8">
                ...
                <div className="w-full bg-[#1a1a3a] rounded-full h-3 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(((progress?.progress || 0) / challenge.target) * 100, 100)}%`,
                    }}
                  />
                </div>
              </div>
              ...
              {progress?.completed ? (
                ...
                <Link
                  href="/play"
                  className="block w-full text-center px-6 py-3 bg-[#00ff88] text-[#0f0f23] font-bold text-lg rounded hover:bg-[#00ccff] transition"
                >
                  Play to Progress
                </Link>
              )}
          ...
          <div className="max-w-2xl mx-auto text-center py-12">
            ...
            <Link
              href="/play"
              className="inline-block px-6 py-2 bg-[#00ff88] text-[#0f0f23] font-bold rounded hover:bg-[#00ccff] transition"
            >
              Play Now
            </Link>
          </div>

...
export default function Home() {
  ...
  const loadStats = async () => {
    try {
      ...
      // Mock stats for now
      setStats({ wins: 0, losses: 0, earnings: '0' })
    } catch (error) {
    ...
    <main className="min-h-screen bg-gradient-to-br from-[#0f0f23] via-[#1a1a3a] to-[#0f0f23]">
      ...
      <nav className="border-b border-[#333333] bg-[#0f0f23]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-6">
            <Link href="/tournaments" className="text-[#ffffff] hover:text-[#00ff88] transition">
              Tournaments
            </Link>
            <Link href="/challenges" className="text-[#ffffff] hover:text-[#00ff88] transition">
              Challenges
            </Link>
            <Link href="/leaderboard" className="text-[#ffffff] hover:text-[#00ff88] transition">
              Leaderboard
            </Link>
            <Link href="/battle-pass" className="text-[#ffffff] hover:text-[#00ff88] transition">
              Battle Pass
            </Link>
          </div>
          <button
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-[#1a1a3a] border border-[#00ff88] rounded p-6 pulse-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Link href="/play" className="group">
            <div className="bg-[#1a1a3a] border border-[#333333] rounded-lg p-6 hover:border-[#00ff88] transition">
          ...
          <Link href="/tournaments" className="group">
            <div className="bg-[#1a1a3a] border border-[#333333] rounded-lg p-6 hover:border-[#00ccff] transition">
              <div className="text-3xl mb-2">🏆</div>
          ...
          <Link href="/challenges" className="group">
            <div className="bg-[#1a1a3a] border border-[#333333] rounded-lg p-6 hover:border-[#ff006e] transition">
              <div className="text-3xl mb-2">📅</div>
        ...
        <div className="text-center">
          {!isConnected ? (
            ...
            <Link
              href="/play"
              className="inline-block px-12 py-4 bg-gradient-to-r from-[#00ff88] to-[#00ccff] text-[#0f0f23] font-bold text-lg rounded hover:shadow-lg hover:shadow-[#00ff88]/50 transition"
            >
              Start Playing Now
            </Link>
          )}

          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <button
                ...
                className="group bg-[#1a1a3a] border border-[#333333] rounded-lg p-8 hover:border-[#00ff88] transition text-left"
              >
              ...
              <button
                ...
                className="group bg-[#1a1a3a] border border-[#333333] rounded-lg p-8 hover:border-[#00ccff] transition text-left"
              >
                <div className="text-4xl mb-4">🏆</div>
              ...
              <button
                ...
                className="group bg-[#1a1a3a] border border-[#333333] rounded-lg p-8 hover:border-[#ff006e] transition text-left"
              >
                <div className="text-4xl mb-4">📅</div>
            ...
            <div className="bg-[#1a1a3a] border border-[#333333] rounded-lg p-8 mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#0f0f23] border border-[#333333] rounded p-4">
                    ...
                    <div className="text-2xl font-bold text-[#00ccff]">
                      {(parseFloat(wagerAmount) * 1.9).toFixed(3)} {wagerType.toUpperCase()}
                    </div>
              ...
              {gameMode === 'tournament' && (
                <div className="space-y-6">
                  ...
                  <Link
                    href="/tournaments"
                    className="block w-full px-6 py-3 bg-[#00ccff] text-[#0f0f23] font-bold text-lg rounded text-center hover:bg-[#00ff88] transition"
                  >
                    Browse Tournaments
                  </Link>
                </div>
              ...
              {gameMode === 'challenge' && (
                <div className="space-y-6">
                  <div className="bg-[#0f0f23] border border-[#333333] rounded p-4">
                    <p className="text-[#666666]">Complete today's challenge. Progress towards the goal is tracked automatically.</p>
                  </div>
                  <Link
                    href="/challenges"
                    className="block w-full px-6 py-3 bg-[#ff006e] text-white font-bold text-lg rounded text-center hover:bg-[#ff3385] transition"
                  >

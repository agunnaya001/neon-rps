...
export function NetworkBanner() {
  ...
  return (
    <div className="bg-destructive/15 border-b-2 border-destructive sticky top-0 z-50">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="font-mono text-sm">
            ...
            <div className="text-muted-foreground">
              Connected to <span className="text-foreground">{actual}</span>. Switch to{" "}
              <span className="text-foreground font-bold">{expected}</span> to play.
            </div>
          </div>
        </div>
        <button
          ...
          disabled={isPending}
          className="arcade-btn px-4 py-2 text-xs whitespace-nowrap shrink-0"
        >

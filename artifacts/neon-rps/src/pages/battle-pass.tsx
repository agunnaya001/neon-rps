        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-[#1a1a3a] border border-[#333333] rounded-lg p-6">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> Daily challenges</li>
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> Leaderboards</li>
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> Standard cosmetics</li>
              <li className="flex items-center text-[#666666]"><span className="text-[#666666] mr-2">✗</span> Premium cosmetics</li>
            </ul>
            <button className="w-full px-4 py-2 bg-[#333333] text-white font-bold rounded cursor-default">
              Current Plan
            </button>
          </div>
          ...
          <div className="bg-[#1a1a3a] border-2 border-[#00ff88] rounded-lg p-6 relative">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> All free features</li>
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> Exclusive cosmetics</li>
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> Custom move animations</li>
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> 0.5% fee discount</li>
              <li className="flex items-center text-white"><span className="text-[#00ff88] mr-2">✓</span> Early access to tournaments</li>
            </ul>
          ...
          <div className="bg-[#1a1a3a] border border-[#ff006e] rounded-lg p-6">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center text-white"><span className="text-[#ff006e] mr-2">✓</span> All premium features</li>
              <li className="flex items-center text-white"><span className="text-[#ff006e] mr-2">✓</span> VIP cosmetics &amp; NFT</li>
              <li className="flex items-center text-white"><span className="text-[#ff006e] mr-2">✓</span> 1% fee discount</li>
              <li className="flex items-center text-white"><span className="text-[#ff006e] mr-2">✓</span> Private tournaments</li>
              <li className="flex items-center text-white"><span className="text-[#ff006e] mr-2">✓</span> Weekly challenges</li>
            </ul>
